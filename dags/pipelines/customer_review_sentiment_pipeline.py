...
def extract_reviews(**context):
    ...
    for i in range(num_reviews):
        ...
        reviews.append({
            ...
            "review_date": (pendulum.now(local_tz) - timedelta(days=random.randint(1, 365))).strftime("%Y-%m-%d")
        })
...
def generate_sentiment_dashboard(**context):
    ...
    # --- Prepare HTML Email Content with Embedded Image (CID method) ---
    # Get the filename for CID embedding, which is more robust than Base64
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="chart-container">
                    ...
                    <img src="cid:{image_filename}" alt="Sentiment Chart" style="width: 100%; max-width: 600px; height: auto; border: 1px solid #ddd; border-radius: 4px;">
                </div>
            </div>
            <div class="footer">
                <p>Generated by Apache Airflow Pipeline • {pendulum.now(local_tz).year}</p>
            </div>
        </div>
    </body>
    </html>
